...
def savePolygonsToFile(file: str) -> None:
  data = None
  i = 0
...
def saveCentroidsToFile(file: str) -> None:
...
def main():
  savePolygonsToFile("geo_polygon_points.csv")
  saveCentroidsToFile("geo_centroid_points.csv")
